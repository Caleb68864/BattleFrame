...
describe("registerInCountryTokenDefaults", () => {
  ...
  it("is a no-op when the registry is absent", () => {
    expect(() => registerInCountryTokenDefaults()).not.toThrow();
  });
});
