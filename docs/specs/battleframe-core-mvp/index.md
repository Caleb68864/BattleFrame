...
> [!warning] The build is gated on SS-01, and SS-01 needs a human
...
> measurement is reachable at all, and therefore whether SS-04 is a small service or a
> full measurement layer plus a ruler replacement (roughly doubling it).
>
> **Nothing downstream should start until SS-01 is answered.** SS-04 is instructed to stop
> and escalate if `vault/foundry-systems/spike-results-measurement.md` does not exist —
> its absence means the gate has not been run, not that it passed.
...
| Wave | Sub-Specs | Note |
|---|---|---|
| 0 | SS-01 | **Manual gate.** Human + licensed Foundry. Everything waits. |
| 1 | SS-02 | Scaffold. Nothing parallelises before it exists. |
| 2 | SS-03, SS-05, SS-07 | Parallel — three independent branches off the scaffold |
| 3 | SS-04, SS-06, SS-08, SS-09 | Parallel |
| 4 | SS-10 | Needs measurement + combat + dice + actor |
| 5 | SS-11 | Needs SS-10's dice pool and action mapping |
| 6 | SS-12 | Integration. Last, by definition. |
